...
//        }
        ...
        public Template createTemplate(Reader reader, String requestedUrl, String scriptFileName, Binding binding) throws CompilationFailedException, IOException {
                ...
                try {
                        ...
                        template.script = groovyShell.parse(script, scriptFileName);
                        //template.script = groovyScriptEngine.createScript(new ByteArrayInputStream(script.getBytes()),requestedUrl, scriptFileName, binding);
