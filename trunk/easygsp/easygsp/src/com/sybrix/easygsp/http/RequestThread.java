...
public class RequestThread extends Thread {
        ...
        private static String altExtension;
        private static String groovyExtension;
        ...
        public void run() {
                ...
                try {
                        ...
                        CustomServletBinding binding = new CustomServletBinding(request, response, application, headers);
...
//                        }
                        ...
                        //processRequest(scriptPath, binding);

                } catch (ApplicationNotFoundException e) {
                        sendError(404, response, e, null);
                } catch (IOException e) {
...
//        }
        ...
        private static void sendError(int errorCode, String scriptPath, GSE3 gse, CustomServletBinding binding, Throwable e) {
                ...
                try {
                        ...
                        if (application.hasCustomErrorFile("error" + errorCode + groovyExtension)) {
                                ...
                                sendError(errorCode, response, e, stackTraceElement);
                        }
        ...
        private static StackTraceElement findErrorInStackTrace(CustomServletBinding binding, Throwable e) {
                File f = (File) binding.getVariable("errorScript");

                for (StackTraceElement stackTraceElement : e.getStackTrace()) {
                        if (stackTraceElement.getFileName().equals(f.getName())) {
        ...
        private static void sendError(int errorCode, ResponseImpl response, Throwable e, StackTraceElement stackTraceElement) {
                TemplateTL.get().setTemplateRoot(null);
                try {
                        ...
                        log.log(Level.FINE, "Error occurred sending static error file", e1);
                }
        }
