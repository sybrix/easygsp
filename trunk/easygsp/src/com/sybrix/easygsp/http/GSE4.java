 ...
 */
public class GSE4 implements ResourceConnector {
...
//                                        RequestThreadInfo.get().getApplication().getAppPath(),"","scriptCache", new Object[]{entryName, cacheEntry}));
         ...
         */
        private GSE4(URL[] roots, ClassLoader parent, ResourceConnector rc) {
        ...
        public GSE4(URL[] roots) {
                this(roots, CL_STUB, null);
        }

        public GSE4(URL[] roots, ClassLoader parentClassLoader) {
                this(roots, parentClassLoader, null);
        }

        public GSE4(String[] urls) throws IOException {
        ...
        public GSE4(String[] urls, ClassLoader parentClassLoader) throws IOException {
                this(createRoots(urls), parentClassLoader, null);
        }

        public GSE4(String url) throws IOException {
                this(new String[]{url});
        }

        public GSE4(String url, ClassLoader parentClassLoader) throws IOException {
                this(new String[]{url}, parentClassLoader);
        }

        public GSE4(ResourceConnector rc) {
                this(null, CL_STUB, rc);
        }

        public GSE4(ResourceConnector rc, ClassLoader parentClassLoader) {
        ...
        public Class loadScriptByName(String script, String requestedUrl, String scriptName, String appPath) throws ResourceException, ScriptException {
                ...
                URLConnection conn = getResourceConnection(requestedUrl);
                InputStream scriptInputStream = null;
                String encoding = null;
                try {
                        encoding = conn.getContentEncoding() != null ? conn.getContentEncoding() : "UTF-8";
                        scriptInputStream = new ByteArrayInputStream(script.getBytes(encoding));
        ...
        public Script createScript(String script, String requestedUrl, String scriptName, Binding binding) throws ResourceException, ScriptException {
