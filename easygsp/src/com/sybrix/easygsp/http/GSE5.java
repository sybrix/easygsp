 ...
 */
public class GSE5 implements ResourceConnector {
        ...
        private class ScriptClassLoader extends GroovyClassLoader {
                ...
                public Class parseClass(GroovyCodeSource codeSource, boolean shouldCacheSource) throws CompilationFailedException {
                        ...
                        for (Map.Entry<String, Set<String>> entry : cache.entrySet()) {
                                ...
                                //System.out.println("compiling codeSource=" + codeSource); 
         ...
         */
        private GSE5(URL[] roots, ClassLoader parent, ResourceConnector rc) {
        ...
        public GSE5(URL[] roots) {
                this(roots, CL_STUB, null);
        }

        public GSE5(URL[] roots, ClassLoader parentClassLoader) {
                this(roots, parentClassLoader, null);
        }

        public GSE5(String[] urls) throws IOException {
        ...
        public GSE5(String[] urls, ClassLoader parentClassLoader) throws IOException {
                this(createRoots(urls), parentClassLoader, null);
        }

        public GSE5(String url) throws IOException {
                this(new String[]{url});
        }

        public GSE5(String url, ClassLoader parentClassLoader) throws IOException {
                this(new String[]{url}, parentClassLoader);
        }

        public GSE5(ResourceConnector rc) {
                this(null, CL_STUB, rc);
        }

        public GSE5(ResourceConnector rc, ClassLoader parentClassLoader) {
        ...
        protected boolean isSourceNewerX(ScriptCacheEntry entry) throws ResourceException {
