 ...
 */
public class CustomServletBinding extends Binding {
         ...
         */
        public CustomServletBinding(HttpServletRequest request, HttpServletResponse response, ServletContext context, Map headers) {
...
//                                headers.put(headerName.substring(5), headerValue);
//                        } else {
