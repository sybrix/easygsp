 ...
 */
package com.sybrix.easygsp.fastcgi;
...
public class FCGIInterface {
        ...
        public int FCGIaccept() {
                ...
                if (!acceptCalled) {
                        ...
                        if (isFCGI) {
                                ...
                                */
                                ...
                                String str = EasyGServer.propertiesFile.getString("fastcgi.port");
                ...
                */
                if (isFCGI) {
                        ...
                        */
                        inputStream = new BufferedInputStream(request.inStream, 8192);
                        outputStream = new PrintStream(new BufferedOutputStream(request.outStream, 8192));
                        errOutputStream = new PrintStream(new BufferedOutputStream(request.errStream, 512));
                        //request.params;
                }
                return 0;
        }
        ...
        */
        public int FCGIAccept() throws IOException {
                ...
                */
                request.params = new HashMap();//new Properties(startupProps);
                switch (request.role) {
                ...
                */
                ...
                request.outStream = new FCGIOutputStream( request.socket.getOutputStream(), 8192, FCGIGlobalDefs.def_FCGIStdout, request);
                request.errStream = new FCGIOutputStream(request.socket.getOutputStream(), 512, FCGIGlobalDefs.def_FCGIStderr, request);
