...
class DAOUtil {
        ...
        public static String databaseUrl="jdbc:firebirdsql:localhost/3050:c:/projects/easygsp/easygsp/databases/app1/app1.fdb"
        public static String databaseUsername="sysdba"
        public static String databasePassword="masterkey"
        public static String databaseDriver = "org.firebirdsql.jdbc.FBDriver"
        ...
        public static void addGetMethod(clazz) {

                clazz.metaClass.'static'.get = {whereMap ->
                        def values = []
                        def sql = new StringBuilder()
                        String columnName
